...
for epoch in range(epochs):
    ...
    for batch in range(4):
        ...
        x1 = [sigmoid(xin[0][0]*W1[0][0] + xin[0][1]*W1[1][0] + b1[0][0]),sigmoid(xin[0][0]*W1[0][1] + xin[0][1]*W1[1][1] + b1[0][1]),sigmoid(xin[0][0]*W1[0][2] + xin[0][1]*W1[1][2] + b1[0][2])]

        x2 = [sigmoid(x1[0]*W2[0][0] + x1[1]*W2[1][0] + x1[2]*W2[2][0] +b2[0][0])]

        # Binary Corss Entropy(BCE)로 loss 계산
        loss = -1*(ans*np.log(x2[0])+(1-ans)*np.log(1-x2[0]))
        ...
        delta_W1 = [[-1*(x2[0]+ans)*W2[0][0]*x2[0]*(1-x2[0])*xin[0][0],-1*(x2[0]+ans)*W2[1][0]*x2[0]*(1-x2[0])*xin[0][0],-1*(x2[0]+ans)*W2[2][0]*x2[0]*(1-x2[0])*xin[0][0]],
                    [-1*(x2[0]+ans)*W2[0][0]*x2[0]*(1-x2[0])*xin[0][1],-1*(x2[0]+ans)*W2[1][0]*x2[0]*(1-x2[0])*xin[0][1],-1*(x2[0]+ans)*W2[2][0]*x2[0]*(1-x2[0])*xin[0][1]]]
        delta_W2 = [[sigmoid(xin[0][0]*W1[0][0] + xin[0][1]*W1[1][0] + b1[0][0])*-1*(x2[0]+ans)],
                    [sigmoid(xin[0][0]*W1[0][1] + xin[0][1]*W1[1][1] + b1[0][1])*-1*(x2[0]+ans)],
                    [sigmoid(xin[0][0]*W1[0][2] + xin[0][1]*W1[1][2] + b1[0][2])*-1*(x2[0]+ans)]]
        #delta_b1 = [[-1*(x2[0]+ans),-1*(x2[0]+ans),-1*(x2[0]+ans)]]
        #delta_b2 = [[-1*(x2[0]+ans)*W2[0][0]]]
        delta_b2 = [[-1*(x2[0]+ans)]]
        delta_b1 = [[-1*(x2[0]+ans)*W2[0][0]*(xin[0][0]*W1[0][0] + xin[0][1]*W1[1][0] + b1[0][0])*x1[0],-1*(x2[0]+ans)*W2[0][0]*(xin[0][0]*W1[0][0] + xin[0][1]*W1[1][0] + b1[0][0])*x1[0],-1*(x2[0]+ans)*W2[0][0]*(xin[0][0]*W1[0][0] + xin[0][1]*W1[1][0] + b1[0][0])*x1[0]]]
...
# 학번에 자신의 학번으로 대체해 주세요.
    ...
    #layer 1개인 경우
np.savetxt("최인성__layer1_weight",(W1, b1),fmt="%s")

    #layer 2개인 경우
np.savetxt("최인성__layer2_weight",(W1, W2, b1, b2),fmt="%s")
